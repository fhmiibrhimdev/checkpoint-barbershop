...
<body>
    ...
    <table>
        ...
        <tbody>
            ...
            $grandTotal = $pesanan->sum('total_komisi_karyawan');
            ...
            <tr>
                ...
                <td style="text-align:center">
                    {{ Carbon::parse($p->tanggal)->translatedFormat('H:i') }}
                </td>
                <td style="text-align: center">{{ $p->nama_pelanggan ?? '-' }}</td>
                <td style="text-align:right">@money($p->total_komisi_karyawan)</td>
            </tr>
            @endforeach
            ...
            <tr style="font-weight:bold; background:#fafafa;">
                ...
                <td style="text-align:right; padding:6px 8px;">
                    @money($rows->sum('total_komisi_karyawan'))
                </td>
            </tr>
            @empty
            <tr>
