                ...
                <form>
                    <div
                        ...
                        <div class="form-group">
                            ...
                            <input type="datetime-local" wire:model.lazy="tanggal" class="form-control">
                            @error('tanggal') <span class='text-danger'>{{ $message }}</span>
                            @enderror
                        </div>
                        <div class='form-group'>
                    ...
                    <div class="modal-footer tw-sticky tw-bottom-[0] tw-bg-white tw-z-50 tw-px-2 tw-block">
