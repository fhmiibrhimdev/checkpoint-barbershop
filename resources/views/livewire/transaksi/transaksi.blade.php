<div>
    ...
    <div class="modal fade tw-pr-[0px] sm:tw-pr-[30px]" data-backdrop="static" wire:ignore.self id="formListItemsModal"
    ...
    <div class="modal fade tw-pr-[0px] sm:tw-pr-[30px]" data-backdrop="static" wire:ignore.self id="formCartItemsModal"
    ...
    <div class="modal fade tw-pr-[0px] sm:tw-pr-[30px]" data-backdrop="static" wire:ignore.self id="formPembayaranModal"
...
<script>
    ...
    window.addEventListener('open-wa', e => {
        console.log('Open WA:', e.detail[0].url);
        window.open(e.detail[0].url, '_blank'); // buka link wa.me di tab baru
    })
