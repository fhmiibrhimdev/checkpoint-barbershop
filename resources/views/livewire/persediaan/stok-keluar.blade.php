                        ...
                        <table class='tw-w-full tw-table-auto'>
                            ...
                            <tbody>
                                ...
                                <tr class='text-center'>
                                    ...
                                    <td class='text-left'>{{ $result->nama_item }}</td>
            ...
            <div class="tw-px-3 -tw-mt-1">
                ...
                <div
                    ...
                    <div class="tw-text-xs tw-flex tw-justify-between tw-items-center">
                        <p class="tw-leading-5 tw-font-semibold tw-text-xs">
                            {{ \Carbon\Carbon::parse($result->tanggal)->format('d M Y') }}
                        </p>
                        <p class="tw-font-semibold">Qty: <span
                                class="tw-text-gray-500 tw-font-normal">{{ $result->qty }}</span>
                        </p>
                        <p class="tw-font-semibold">CREATED BY: <span
                                class="tw-text-gray-500 tw-font-normal">{{ Str::limit($result->name, 7, '...') }}</span>
                        </p>
