                        ...
                        <table class='tw-w-full tw-table-auto'>
                            <thead class='tw-sticky tw-top-0'>
                                <tr class='tw-text-gray-700'>
                                    ...
                                    <th class='tw-whitespace-nowrap'>Kategori Pemasukan</th>
                ...
                <form>
                    <div class='modal-body'>
                        <div class='form-group'>
                            <label for='id_kategori_keuangan'>Kategori Pemasukan</label>
                            ...
                            @error('id_kategori_keuangan') <span class='text-danger'>Kategori Pemasukan wajib
                                dipilih</span>
                            @enderror
                        </div>
                        <div class='form-group'>
