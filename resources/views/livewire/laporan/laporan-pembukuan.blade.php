                        ...
                        <table class='tw-w-full tw-table-auto'>
                            <thead class="tw-sticky tw-top-0">
                                <tr class="tw-text-gray-700">
                                    ...
                                    <th class="tw-whitespace-nowrap">Masuk</th>
                                    <th class="tw-whitespace-nowrap">Keluar</th>
                                </tr>
                            </thead>
                            <tbody>
                                @php
                                ...
                                // Kelompokkan per TANGGAL (tanpa jam) pakai kolom "waktu"
                                $groups = $data->getCollection()->groupBy(function ($item) {
                                return Carbon::parse($item->waktu)->toDateString(); // 'YYYY-MM-DD'
                                });
                                @endphp
                                ...
                                <tr>
                                    ...
                                    <td>@money($row->masuk)</td>
                                    <td>@money($row->keluar)</td>
                                </tr>
                                @endforeach
                                @empty
                                <tr>
