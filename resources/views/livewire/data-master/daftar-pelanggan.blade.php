                        ...
                        <table class='tw-w-full tw-table-auto'>
                            <thead class='tw-sticky tw-top-0'>
                                <tr class='tw-text-gray-700'>
                                    ...
                                    <th class='tw-whitespace-nowrap'>Jenis Kelamin</th>
                                    <th class='tw-whitespace-nowrap'>Total Kunjungan</th>
                            ...
                            <tbody>
                                ...
                                <tr class='text-center'>
                                    ...
                                    <td class='tw-whitespace-nowrap text-left'>{{ $result->jk }}</td>
                                    <td class='tw-whitespace-nowrap text-left'>{{ $result->total_kunjungan }}</td>
            ...
            <div class="tw-px-3 -tw-mt-1">
                ...
                <div
                    ...
                    <div class="tw-flex tw-justify-between tw-items-center">
                        <div class="tw-flex tw-items-center">
                            ...
                            <div class="tw-text-[#34395e] tw-tracking-[0.5px] tw-text-xs">
                                <p class="tw-leading-5 tw-font-semibold tw-text-sm">{{ $result->nama_pelanggan }}</p>
                                <p class="tw-leading-5">{{ $result->jk }}</p>
                    ...
                    <div class="tw-text-xs tw-flex tw-justify-between">
                        <p class="tw-font-semibold">Kunjungan: <span
                                class="tw-text-gray-500 tw-font-normal">{{ $result->total_kunjungan }}</span>
                        </p>
