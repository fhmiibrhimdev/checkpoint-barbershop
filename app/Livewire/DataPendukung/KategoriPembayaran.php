...
class KategoriPembayaran extends Component
{
    ...
    public function render()
    {
        ...
        $data = DB::table('kategori_pembayaran')->select('kategori_pembayaran.id', 'kategori_pembayaran.nama_kategori', 'kategori_pembayaran.deskripsi', 'kategori_pembayaran.can_update_delete')
            // ->join('cabang_lokasi', 'kategori_pembayaran.id_cabang', '=', 'cabang_lokasi.id')
