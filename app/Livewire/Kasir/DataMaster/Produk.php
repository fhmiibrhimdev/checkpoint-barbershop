...
namespace App\Livewire\Kasir\DataMaster;
...
class Produk extends Component
{
    ...
    public function mount(GlobalDataService $globalDataService)
    {
        ...
        $this->kategoris  = $this->globalDataService->getKategorisCustom()->whereIn('id', ['1', '4'])->get();
    ...
    public function render()
    {
        ...
        return view('livewire.kasir.data-master.produk', compact('data', 'komisi_data'));
    }
