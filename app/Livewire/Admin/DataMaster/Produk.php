...
class Produk extends Component
{
    ...
    public function mount(GlobalDataService $globalDataService)
    {
        ...
        $this->karyawans = $this->globalDataService->getKaryawansCustom($this->id_cabang ?? optional($this->cabangs->first())->id);
        // dd($this->karyawans);
    ...
    public function render()
    {
        ...
        return view('livewire.admin.data-master.produk', compact('data', 'komisi_data'));
    }
