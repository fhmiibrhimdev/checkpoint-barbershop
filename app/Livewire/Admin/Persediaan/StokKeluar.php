...
namespace App\Livewire\Admin\Persediaan;
...
class StokKeluar extends Component
{
    ...
    {
        $this->id_cabang = Auth::user()->id_cabang; // Set default cabang to user's cabang
    ...
    public function render()
    {
        ...
        return view('livewire.admin.persediaan.stok-keluar', compact('data'));
    }
    ...
    public function update()
    {
        ...
        $total = (int)$qty_lama - (int)$qty_baru; // 3 - 10 = -7
    ...
    public function delete()
    {
        ...
        $total_stock = $stock_terakhir + $qty_terakhir; // Tambah stock dengan quantity yang dihapus
