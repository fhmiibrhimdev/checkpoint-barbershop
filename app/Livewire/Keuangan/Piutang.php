...
class Piutang extends Component
{
    ...
    public function render()
    {
        ...
        if ($this->id_transaksi == null) {
            ...
            return view('livewire.transaksi.piutang-all', compact('data'));
        } else {
    ...
    private function getReportHarian()
    {
        ...
        $this->totalOmset       = (int)$transaksiHariIni->total_omset;
        $this->totalTunai       = (int)$transaksiHariIni->total_tunai + ((int)$piutangHariIni->piutang_tunai ?? 0);
        $this->totalTransfer    = (int)$transaksiHariIni->total_transfer + ((int)$piutangHariIni->piutang_transfer ?? 0);
